    ...
    <div class="card p-2">
                    ...
                    <tr class="text-center" data-role-id="{{ $role->id }}">
                        ...
                        <td>
                            <div>
                                ...
                                &nbsp;
                                <a href="{{ route('dashboard.role.permission.assign.permission', $role->id) }}"
                                    class="btn btn-outline-info d-inline-flex align-items-center justify-content-center p-1">
                                    <iconify-icon icon="hugeicons:authorized" width="16" height="16"></iconify-icon>
                                </a>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="modal fade" id="assignPermissionModal" tabindex="-1" aria-labelledby="assignPermissionLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="assignPermissionLabel">Assign Permissions</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
